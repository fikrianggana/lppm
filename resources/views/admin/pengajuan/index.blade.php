                        ...
                        <table class="table table-hover table-bordered table-condensed table-striped grid">
                            ...
                            <tbody>
                                @forelse ($pengajuan as $pst)
                                    @if ($pst->status != "0") <!-- Add this condition to filter out "Belum Terkirim" records -->
                                    <tr>
                                        <td>
                                            @php
                                        ...
                                        <td class="text-center">
                                            <!-- Confirm Button -->
                                            <a href="{{ route('admin.pengajuan.confirm', ['pst_id' => $pst->pst_id]) }}" class="btn btn-success">
                                                <i class="fa fa-check" aria-hidden="true"></i> 
                                            </a>

                                            <!-- Reject Button -->
                                            <a href="{{ route('admin.pengajuan.reject', ['pst_id' => $pst->pst_id]) }}" class="btn btn-danger">
