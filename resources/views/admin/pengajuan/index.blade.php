                                ...
                                @forelse ($pengajuan as $index => $pst)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @if ($pst->status === 1)
                                            <!-- Confirm Button -->
                                            <a href="#" class="btn btn-default confirm-button" data-toggle="modal" data-target="#modal-validation" data-pstid="{{ $pst->pst_id }}">
                                            ...
                                            <!-- Reject Button -->
                                            <a href="#" class="btn btn-default reject-button" data-toggle="modal" data-target="#modal-reject" data-pstid="{{ $pst->pst_id }}">
                                            ...
                                            @if ($pst->status === 2)
                                                ...
                                                <a href="#" data-toggle="modal" data-target="#modal-feedback" data-pstid="{{ $pst->pst_id }}" class="btn btn-default feedback-button">
