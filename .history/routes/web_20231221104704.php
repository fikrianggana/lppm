...
Route::put('buku/{bku_id}', [BukuController::class, 'update'])->name('admin.publikasibuku.update');
Route::delete('buku/{bku_id}', [BukuController::class, 'destroy'])->name('admin.publikasi.destroy');
