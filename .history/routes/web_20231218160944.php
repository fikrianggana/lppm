...
Route::get('pengajuan/create', [PengabdianMasyarakatController::class, 'create'])->name('karyawan.penpengajuangabdian.create');
Route::post('pengajuan', [PengabdianMasyarakatController::class, 'store'])->name('karyawan.pengajuan.store');
