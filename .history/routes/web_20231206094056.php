...
Route::post('pengabdian', [PengabdianMasyarakatController::class, 'store'])->name('pengabdian.store');
Route::get('pengabdian/{id}/edit', [PengabdianMasyarakatController::class, 'edit'])->name('karyawan.pengabdian.edit');
Route::put('pengabdian/{id}', [PengabdianMasyarakatController::class, 'update'])->name('karyawan.pengabdian.update');
Route::delete('pengabdian/{id}', [PengabdianMasyarakatController::class, 'destroy'])->name('karyawan.pengabdian.destroy');
