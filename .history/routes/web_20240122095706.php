...
*/
    ...
    Route::middleware(['auth', 'userAccess:admin'])->group(function () {
        ...
        Route::get('pengajuan/{pdn_id}/confirm', [PengajuanSuratTugasController::class, 'confirm'])->name('admin.pengajuan.confirm');
        Route::post('pengajuan/{pdn_id}/reject', [PengajuanSuratTugasController::class, 'reject'])->name('admin.pengajuan.reject');
        Route::post('pengajuan/{pst_id}/kirimSurat', [PengajuanSuratTugasController::class, 'kirimSuratTugas'])->name('admin.pengajuan.kirim');
