...
Route::get('pengabdian/{pkm_id}/edit', [HakCiptaController::class, 'edit'])->name('admin.pengabdian.edit');
Route::put('pengabdian/{pkm_id}', [HakCiptaController::class, 'update'])->name('admin.pengabdian.update');
Route::delete('pengabdian/{pkm_id}', [HakCiptaController::class, 'destroy'])->name('admin.pengabdian.destroy');
...
Route::get('pengabdian/{pkm_id}/edit', [HakPatenController::class, 'edit'])->name('admin.pengabdian.edit');
Route::put('pengabdian/{pkm_id}', [HakPatenController::class, 'update'])->name('admin.pengabdian.update');
Route::delete('pengabdian/{pkm_id}', [HakPatenController::class, 'destroy'])->name('admin.pengabdian.destroy');
...
Route::get('pengabdian/{pkm_id}/edit', [ProsidingController::class, 'edit'])->name('admin.pengabdian.edit');
Route::put('pengabdian/{pkm_id}', [ProsidingController::class, 'update'])->name('admin.pengabdian.update');
Route::delete('pengabdian/{pkm_id}', [ProsidingController::class, 'destroy'])->name('admin.pengabdian.destroy');
