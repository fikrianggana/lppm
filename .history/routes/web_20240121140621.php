...
*/
    ...
    Route::middleware(['auth', 'userAccess:karyawan'])->group(function () {
        ...
        Route::get('pengaduanKaryawan/{pdn_id}/edit', [PengajuanSuratTugasController::class, 'edit'])->name('karyawan.pengaduan.edit');
        Route::put('pengajuanKaryawan/{pdn_id}', [PengajuanSuratTugasController::class, 'update'])->name('karyawan.pengaduan.update');
        Route::delete('pengajuanKaryawan/{pst_id}', [PengajuanSuratTugasController::class, 'destroy'])->name('karyawan.pengaduan.destroy');
        Route::get('pengajuanKaryawan/{pst_id}', [PengajuanSuratTugasController::class, 'kirim'])->name('karyawan.pengaduan.kirim');
