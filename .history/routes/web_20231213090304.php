...
Route::get('buku/{bku_id}/edit', [BukuController::class, 'edit'])->name('karyawan.publikasi.buku.edit');
Route::put('buku/{bku_id}', [BukuController::class, 'update'])->name('karyawan.publikasi.buku.update');
Route::delete('buku/{bku_id}', [BukuController::class, 'destroy'])->name('karyawan.publikasi.buku.destroy');
...
Route::get('prosiding/create', [HakPatenController::class, 'create'])->name('karyawan.publikasi.prosiding.create');
Route::post('prosiding', [HakPatenController::class, 'store'])->name('karyawan.publikasi.prosiding.store');
