...
Route::get('prosiding/{pro_id}/edit', [ProsidingController::class, 'edit'])->name('admin.pengabdian.edit');
Route::put('prosiding/{pro_id}', [ProsidingController::class, 'update'])->name('admin.pengabdian.update');
Route::delete('prosiding/{pro_id}', [ProsidingController::class, 'destroy'])->name('admin.pengabdian.destroy');
