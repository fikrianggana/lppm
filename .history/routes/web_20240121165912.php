...
*/
    ...
    Route::middleware(['auth', 'userAccess:karyawan'])->group(function () {
        ...
        Route::get('pengaduanKaryawan/{type}', [PengaduanController::class, 'getData'])->name('pengaduan.getData');
        use App\Http\Controllers\PengaduanController; // Gantilah dengan namespace dan nama controller yang sesuai
