...
Route::get('pengabdian/{pkm_id}', [PengabdianMasyarakatController::class, 'destroy'])->name('admin.pengabdian.destroy');
...
Route::get('pengajuan/{pst_id}', [PengajuanSuratTugasController::class, 'destroy'])->name('admin.pengajuan.destroy');
...
Route::pogst('buku/{bku_id}', [BukuController::class, 'update'])->name('admin.publikasi.buku.update');
...
Route::get('jurnal/{jrn_id}', [JurnalController::class, 'destroy'])->name('admin.publikasi.jurnal.destroy');
...
Route::get('seminar/{smn_id}', [SeminarController::class, 'destroy'])->name('admin.publikasi.seminar.destroy');
...
Route::get('hakcipta/{hcp_id}', [HakCiptaController::class, 'destroy'])->name('admin.publikasi.hakcipta.destroy');
...
Route::get('hakpaten/{hpt_id}', [HakPatenController::class, 'destroy'])->name('admin.publikasi.hakpaten.destroy');
...
Route::get('prosiding/{pro_id}', [ProsidingController::class, 'destroy'])->name('admin.publikasi.prosiding.destroy');
