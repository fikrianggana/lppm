...
Route::get('buku/{id}/edit', [BukuController::class, 'edit'])->name('admin.publikasi.buku.edit');
Route::put('buku/{id}', [BukuController::class, 'update'])->name('admin.publikasi.buku.update');
Route::delete('buku/{id}', [BukuController::class, 'destroy'])->name('admin.publikasi.buku.destroy');
