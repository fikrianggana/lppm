...
Route::get('pengabdian/create', [ProductController::class, 'create'])->name('products.create');
Route::post('pengabdian', [ProductController::class, 'store'])->name('products.store');
Route::get('pengabdian/{id}/edit', [ProductController::class, 'edit'])->name('products.edit');
Route::put('pengabdian/{id}', [ProductController::class, 'update'])->name('products.update');
Route::delete('pengabdian/{id}', [ProductController::class, 'destroy'])->name('products.destroy');
