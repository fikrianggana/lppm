...
Route::get('buku/create', [PengabdianMasyarakatController::class, 'create'])->name('karyawan.pengabdian.create');
Route::post('buku', [PengabdianMasyarakatController::class, 'store'])->name('karyawan.pengabdian.store');
Route::get('buku/{pkm_id}/edit', [PengabdianMasyarakatController::class, 'edit'])->name('karyawan.pengabdian.edit');
Route::put('buku/{bku_id}', [PengabdianMasyarakatController::class, 'update'])->name('karyawan.pengabdian.update');
Route::delete('buku/{pkm_id}', [PengabdianMasyarakatController::class, 'destroy'])->name('karyawan.pengabdian.destroy');
