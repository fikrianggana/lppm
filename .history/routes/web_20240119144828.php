...
*/
    ...
    Route::middleware(['auth', 'userAccess:admin'])->group(function () {
        ...
        //Pengaduan
        Route::get('pengajuan',[PengaduanController::class,'index'])->name('admin.pengaduan.index');
        Route::get('pengajuan/{pst_id}/confirm', [PengaduanController::class, 'confirm'])->name('admin.pengajuan.confirm');
        Route::post('pengajuan/{pst_id}/reject', [PengaduanController::class, 'reject'])->name('admin.pengaduan.reject');
