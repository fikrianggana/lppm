...
*/
    ...
    Route::middleware(['auth', 'userAccess:admin'])->group(function () {
        ...
        Route::get('pengaduan/{pdn_id}/confirm', [PengajuanSuratTugasController::class, 'confirm'])->name('admin.pengajuan.confirm');
        Route::post('pengaduan/{pdn_id}/reject', [PengajuanSuratTugasController::class, 'reject'])->name('admin.pengajuan.reject');
        Route::post('pengaduan/{pst_id}/kirimSurat', [PengajuanSuratTugasController::class, 'kirimSuratTugas'])->name('admin.pengajuan.kirim');
