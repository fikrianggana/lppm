...
Route::get('hakpaten/{pkm_id}/edit', [HakPatenController::class, 'edit'])->name('admin.pengabdian.edit');
Route::put('hakpaten/{pkm_id}', [HakPatenController::class, 'update'])->name('admin.pengabdian.update');
Route::delete('hakpaten/{pkm_id}', [HakPatenController::class, 'destroy'])->name('admin.pengabdian.destroy');
