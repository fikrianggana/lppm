...
Route::get('buku/{bku_id}/edit', [PengabdianMasyarakatController::class, 'edit'])->name('karyawan.pengabdian.edit');
Route::put('buku/{bku_id}', [PengabdianMasyarakatController::class, 'update'])->name('karyawan.pengabdian.update');
Route::delete('buku/{bku_id}', [PengabdianMasyarakatController::class, 'destroy'])->name('karyawan.pengabdian.destroy');
