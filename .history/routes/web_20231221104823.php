...
Route::get('prosiding/{pkm_id}/edit', [ProsidingController::class, 'edit'])->name('admin.pengabdian.edit');
Route::put('prosiding/{pkm_id}', [ProsidingController::class, 'update'])->name('admin.pengabdian.update');
Route::delete('prosiding/{pkm_id}', [ProsidingController::class, 'destroy'])->name('admin.pengabdian.destroy');
