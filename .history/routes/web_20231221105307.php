...
Route::get('jurnal/{jrn_id}/edit', [JurnalController::class, 'edit'])->name('admin.publikasi.edit');
Route::put('jurnal/{jrn_id}', [JurnalController::class, 'update'])->name('admin.publikasi.update');
Route::delete('jurnal/{jrn_id}', [JurnalController::class, 'destroy'])->name('admin.publikasi.destroy');
