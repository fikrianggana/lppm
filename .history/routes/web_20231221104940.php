...
Route::get('hakpaten/{hpt_id}/edit', [HakPatenController::class, 'edit'])->name('admin.publikasi.edit');
Route::put('hakpaten/{hpt_id}', [HakPatenController::class, 'update'])->name('admin.publikasi.update');
