...
Route::get('seminar/{smn_id}/edit', [SeminarController::class, 'edit'])->name('admin.pengabdian.edit');
Route::put('seminar/{smn_id}', [SeminarController::class, 'update'])->name('admin.pengabdian.update');
