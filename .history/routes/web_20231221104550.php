...
Route::get('pengajuan/{pkm_id}/edit', [PengajuanSuratTugasController::class, 'edit'])->name('admin.pengajuan.edit');
Route::put('pengajuan/{pkm_id}', [PengajuanSuratTugasController::class, 'update'])->name('admin.pengajuan.update');
Route::delete('pengajuan/{pkm_id}', [PengajuanSuratTugasController::class, 'destroy'])->name('admin.pengajuan.destroy');
...
Route::get('pengabdian/{pst_id}/edit', [PengabdianMasyarakatController::class, 'edit'])->name('admin.pengabdian.edit');
Route::put('pengabdian/{pst_id}', [PengabdianMasyarakatController::class, 'update'])->name('admin.pengabdian.update');
Route::delete('pengabdian/{pst_id}', [PengabdianMasyarakatController::class, 'destroy'])->name('admin.pengabdian.destroy');
