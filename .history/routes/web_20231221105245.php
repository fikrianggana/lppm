...
Route::get('seminar/{smn_id}/edit', [SeminarController::class, 'edit'])->name('admin.publikasi.edit');
Route::put('seminar/{smn_id}', [SeminarController::class, 'update'])->name('admin.publikasi.update');
Route::delete('seminar/{smn_id}', [SeminarController::class, 'destroy'])->name('admin.publikasi.destroy');
