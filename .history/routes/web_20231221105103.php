...
Route::get('hakcipta/{hcp_id}/edit', [HakCiptaController::class, 'edit'])->name('admin.publikasi.edit');
Route::put('hakcipta/{hcp_id}', [HakCiptaController::class, 'update'])->name('admin.publikasi.update');
Route::delete('hakcipta/{hcp_id}', [HakCiptaController::class, 'destroy'])->name('admin.publikasi.destroy');
