...
Route::get('jurnal/{jrn_)id}/edit', [JurnalController::class, 'edit'])->name('admin.pengabdian.edit');
Route::put('jurnal/{pkm_id}', [JurnalController::class, 'update'])->name('admin.pengabdian.update');
Route::delete('jurnal/{pkm_id}', [JurnalController::class, 'destroy'])->name('admin.pengabdian.destroy');
