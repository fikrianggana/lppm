...
Route::get('hakcipta/{pkm_id}/edit', [HakCiptaController::class, 'edit'])->name('admin.pengabdian.edit');
Route::put('hakcipta/{pkm_id}', [HakCiptaController::class, 'update'])->name('admin.pengabdian.update');
Route::delete('hakcipta/{pkm_id}', [HakCiptaController::class, 'destroy'])->name('admin.pengabdian.destroy');
