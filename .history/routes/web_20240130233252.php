...
*/
    ...
    Route::middleware(['auth', 'userAccess:admin'])->group(function () {
        ...
        //Prodi
        Route::get('prodi', [UserController::class, 'index'])->name('admin.user.index');
        Route::get('prodi/create', [UserController::class, 'create'])->name('admin.user.create');
        Route::post('prodi', [UserController::class, 'store'])->name('admin.user.store');
