...
//Buku
Route::get('buku',[BukuController::class,'index'])->name('admin.publikasi.buku.index')->middleware('userAccess:admin');
Route::get('buku/create', [BukuController::class, 'create'])->name('admin.publikasi.buku.create')->middleware('userAccess:admin');
Route::post('buku', [BukuController::class, 'store'])->name('admin.publikasi.buku.store')->middleware('userAccess:admin');
Route::get('buku/{bku_id}/edit', [BukuController::class, 'edit'])->name('admin.publikasi.buku.edit')->middleware('userAccess:admin');
Route::put('buku/{bku_id}', [BukuController::class, 'update'])->name('admin.publikasi.buku.update')->middleware('userAccess:admin');
Route::delete('buku/{bku_id}', [BukuController::class, 'destroy'])->name('admin.publikasi.buku.destroy')->middleware('userAccess:admin');
