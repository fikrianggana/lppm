...
Route::get('pengajuan/{pkm_id}/edit', [PengajuanSuratTugasController::class, 'edit'])->name('admin.pengabdian.edit');
Route::put('pengajuan/{pkm_id}', [PengajuanSuratTugasController::class, 'update'])->name('admin.pengabdian.update');
