...
Route::get('/logout',[LoginController::class, 'logout'])->name('logout');
    ...
    Route::middleware(['auth', 'userAccess:admin'])->group(function () {
        ...
        Route::get('seminarexport', [JurnalController::class, 'seminarexport'])->name('admin.publikasi.seminar.export');
        ...
        Route::get('hakciptaexport', [HakCiptaController::class, 'jurnalexport'])->name('admin.publikasi.jurnal.export');
