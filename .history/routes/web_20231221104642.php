...
Route::get('buku/{bku_id}/edit', [BukuController::class, 'edit'])->name('admin.pengabdian.edit');
Route::put('buku/{bku_id}', [BukuController::class, 'update'])->name('admin.pengabdian.update');
Route::delete('buku/{bku_id}', [BukuController::class, 'destroy'])->name('admin.pengabdian.destroy');
