...
*/
    ...
    Route::middleware(['auth', 'userAccess:karyawan'])->group(function () {
        ...
        Route::put('pengajuanKaryawan/{pdn_id}', [PengaduanController::class, 'update'])->name('karyawan.pengaduan.update');
        Route::delete('pengajuanKaryawan/{pst_id}', [PengaduanController::class, 'destroy'])->name('karyawan.pengaduan.destroy');
        Route::get('pengajuanKaryawan/{pst_id}', [PengaduanController::class, 'kirim'])->name('karyawan.pengaduan.kirim');
