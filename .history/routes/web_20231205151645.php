...
Route::get('hakcipta',[BukuController::class,'index'])->name('karyawan.publikasi.buku.index');
Route::get('hakpaten',[BukuController::class,'index'])->name('karyawan.publikasi.buku.index');
Route::get('prosiding',[BukuController::class,'index'])->name('karyawan.publikasi.buku.index');
