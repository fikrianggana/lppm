...
*/
    ...
    Route::middleware(['auth', 'userAccess:admin'])->group(function () {
        ...
        Route::get('user/export', [UserController::class, 'userexport'])->name('admin.user.export');
        ...
        Route::get('prodi/{prd_id}/edit', [UserController::class, 'edit'])->name('admin.prodi.edit');
        Route::put('prodi/{prd_id}', [UserController::class, 'update'])->name('admin.prodi.update');
