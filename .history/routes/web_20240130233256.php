...
*/
    ...
    Route::middleware(['auth', 'userAccess:admin'])->group(function () {
        ...
        Route::get('prodi/{pkm_id}/edit', [UserController::class, 'edit'])->name('admin.user.edit');
        Route::put('prodi/{pkm_id}', [UserController::class, 'update'])->name('admin.user.update');
        Route::delete('prodi/{pkm_id}', [UserController::class, 'destroy'])->name('admin.user.destroy');
