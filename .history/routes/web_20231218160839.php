...
Route::get('pengajuan/create', [PengabdianMasyarakatController::class, 'create'])->name('karyawan.pengabdian.create');
Route::post('pengajuan', [PengabdianMasyarakatController::class, 'store'])->name('karyawan.pengabdian.store');
