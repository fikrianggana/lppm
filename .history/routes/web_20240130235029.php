...
*/
    ...
    Route::middleware(['auth', 'userAccess:admin'])->group(function () {
        ...
        Route::get('user/{pkm_id}/edit', [UserController::class, 'edit'])->name('admin.user.edit');
        Route::put('user/{pkm_id}', [UserController::class, 'update'])->name('admin.user.update');
        Route::delete('user/{pkm_id}', [UserController::class, 'destroy'])->name('admin.user.destroy');
        Route::get('user/pengabdianexport', [PengabdianMasyarakatController::class, 'pengabdianexport'])->name('admin.pengabdian.export');


        //Prodi
        Route::get('prodi', [UserController::class, 'index'])->name('admin.prodi.index');
        Route::get('prodi/create', [UserController::class, 'create'])->name('admin.prodi.create');
        Route::post('prodi', [UserController::class, 'store'])->name('admin.user.prodi');
        Route::get('prodi/{pkm_id}/edit', [UserController::class, 'edit'])->name('admin.prodi.edit');
        Route::put('prodi/{pkm_id}', [UserController::class, 'update'])->name('admin.prodi.update');
        Route::delete('prodi/{pkm_id}', [UserController::class, 'destroy'])->name('admin.prodi.destroy');
        ...
        Route::post('pengaduan/{pdn_id}/kirimPengaduan', [PengaduanController::class, 'kirimPengaduan'])->name('admin.pengaduan.kirim');
    ...
    Route::middleware(['auth', 'userAccess:karyawan'])->group(function () {
        ...
        Route::get('/pengaduan/get-data', [PengaduanController::class, 'getData']);
