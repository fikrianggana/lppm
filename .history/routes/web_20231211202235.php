...
Route::get('pengabdian/create', [HakCiptaController::class, 'create'])->name('karyawan.pengabdian.create');

//Hakpaten
Route::get('hakpaten',[HakPatenController::class,'index'])->name('karyawan.publikasi.hakpaten.index');
Route::get('hakpaten/create', [HakPatenController::class, 'create'])->name('karyawan.pengabdian.create');
