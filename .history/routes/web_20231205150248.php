...
Route::get('pengajuan',[PengabdianMasyarakatController::class,'index'])->name('karyawan.pengabdian.index');



Route::get('publikasi',[PublikasiMasyarakatController::class,'index'])->name('karyawan.publikasi.index');
