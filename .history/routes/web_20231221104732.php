...
Route::get('jurnal/{pkm_id}/edit', [JurnalController::class, 'edit'])->name('admin.pengabdian.edit');
Route::put('jurnal/{pkm_id}', [jurnal::class, 'update'])->name('admin.pengabdian.update');
