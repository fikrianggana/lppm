...
Route::get('seminar/{pkm_id}/edit', [SeminarController::class, 'edit'])->name('admin.pengabdian.edit');
Route::put('seminar/{pkm_id}', [SeminarController::class, 'update'])->name('admin.pengabdian.update');
Route::delete('seminar/{smn_id}', [SeminarController::class, 'destroy'])->name('admin.pengabdian.destroy');
