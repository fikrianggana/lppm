...
//Pengajuan
Route::get('pengajuan',[PengajuanSuratTugasController::class,'index'])->name('karyawan.pengajuan.index');Route::get('publikasi',[PublikasiController::class,'index'])->name('karyawan.publikasi.index');
