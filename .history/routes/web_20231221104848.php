...
Route::put('prosiding/{pro_id}', [ProsidingController::class, 'update'])->name('admin.publikasi.update');
Route::delete('prosiding/{pro_id}', [ProsidingController::class, 'destroy'])->name('admin.publikasi.destroy');
