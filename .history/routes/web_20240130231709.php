...
*/
    ...
    Route::middleware(['auth', 'userAccess:admin'])->group(function () {
        ...
        //Pengguna
        Route::get('pengguna', [PengabdianMasyarakatController::class, 'index'])->name('admin.pengabdian.index');
        Route::get('pengguna/create', [PengabdianMasyarakatController::class, 'create'])->name('admin.pengabdian.create');
        Route::post('pengguna', [PengabdianMasyarakatController::class, 'store'])->name('admin.pengabdian.store');
        Route::get('pengguna/{pkm_id}/edit', [PengabdianMasyarakatController::class, 'edit'])->name('admin.pengabdian.edit');
        Route::put('pengguna/{pkm_id}', [PengabdianMasyarakatController::class, 'update'])->name('admin.pengabdian.update');
        Route::delete('pengguna/{pkm_id}', [PengabdianMasyarakatController::class, 'destroy'])->name('admin.pengabdian.destroy');
