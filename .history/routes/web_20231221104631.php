...
Route::get('buku/{}/edit', [BukuController::class, 'edit'])->name('admin.pengabdian.edit');
Route::put('buku/{pkm_id}', [BukuController::class, 'update'])->name('admin.pengabdian.update');
