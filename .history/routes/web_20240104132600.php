...
Route::middleware(['auth'])->group(function () {
    Route::middleware(['userAccess:admin'])->prefix('admin')->group(function () {
        ...
        // ... Rute publikasi admin ...
    });

    Route::middleware(['userAccess:karyawan'])->prefix('karyawan')->group(function () {
        Route::get('/dashboardKaryawan', [DashboardKaryawanController::class, 'index'])->name('karyawan.dashboard.index');
        // ... Rute publikasi karyawan ...
    });
});
...
Route::get('/logout', [LoginController::class, 'logout'])->name('logout')->middleware('auth');
    ...
    Route::middleware(['auth', 'userAccess:karyawan'])->group(function () {
        ...
        Route::get('pengajuanKaryawan/create', [PengajuanSuratTugasController::class, 'create'])->name('karyawan.penpengajuangabdian.create');
