...
*/
    ...
    Route::middleware(['auth', 'userAccess:admin'])->group(function () {
        ...
        Route::post('prodi', [ProdiController::class, 'store'])->name('admin.user.prodi');
        Route::get('prodi/{prd_id}/edit', [ProdiController::class, 'edit'])->name('admin.prodi.edit');
        Route::put('prodi/{prd_id}', [ProdiController::class, 'update'])->name('admin.prodi.update');
        Route::delete('prodi/{prd_id}', [ProdiController::class, 'destroy'])->name('admin.prodi.destroy');
        Route::get('prodi/export', [ProdiController::class, 'prodiexport'])->name('admin.prodi.export');
