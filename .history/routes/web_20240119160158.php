...
*/
    ...
    Route::middleware(['auth', 'userAccess:admin'])->group(function () {
        ...
        Route::get('pengaduan/{pst_id}/confirm', [PengaduanController::class, 'confirm'])->name('admin.pengaduan.confirm');
        Route::post('pengaduan/{pst_id}/reject', [PengaduanController::class, 'reject'])->name('admin.pengaduan.reject');
        Route::get('pengajuan/surattugasexport', [PengaduanController::class, 'surattugasexport'])->name('admin.pengajuan.export');
