...
*/
    ...
    Route::middleware(['auth', 'userAccess:admin'])->group(function () {
        ...
        Route::get('user/create', [UserController::class, 'create'])->name('admin.pengabdian.create');
        Route::post('user', [UserController::class, 'store'])->name('admin.pengabdian.store');
        Route::get('user/{pkm_id}/edit', [UserController::class, 'edit'])->name('admin.pengabdian.edit');
        Route::put('user/{pkm_id}', [UserController::class, 'update'])->name('admin.pengabdian.update');
        Route::delete('user/{pkm_id}', [UserController::class, 'destroy'])->name('admin.pengabdian.destroy');
