...
Route::get('hakpaten/{hpt_id}/edit', [HakPatenController::class, 'edit'])->name('admin.pengabdian.edit');
Route::put('hakpaten/{hpt_id}', [HakPatenController::class, 'update'])->name('admin.pengabdian.update');
Route::delete('hakpaten/{hpt_id}', [HakPatenController::class, 'destroy'])->name('admin.pengabdian.destroy');
