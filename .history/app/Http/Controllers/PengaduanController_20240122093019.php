...
class PengaduanController extends Controller
{
    ...
    public function edit(Pengaduan $pengaduan, $pdn_id)
    {
        ...
        if ($usr_role === 'karyawan') {
            return view('karyawan.pengaduan.edit', compact('title', 'pengaduan'), ['users' => $user, 'pdn' => $pst]);
        } elseif ($usr_role === 'admin') {
            return view('admin.pengaduan.edit', compact('title', 'pengaduan'), ['users' => $user, 'pdn' => $pst]);
        } else {
            // Handle jika peran tidak teridentifikasi
            return abort(403, 'Unauthorized action.');
        }
