...
class PengajuanSuratTugasController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($usr_role === 'karyawan') {
            return view('karyawan.pengajuan.index', ['pengabdian' => $pengabdianMasyarakat, 'prodis' => $prodis, 'users' => $user]);
        } elseif ($usr_role === 'admin') {
            return view('admin.pengajuan.index', ['pengabdian' => $pengabdianMasyarakat, 'prodis' => $prodis, 'users' => $user]);
        } else {
