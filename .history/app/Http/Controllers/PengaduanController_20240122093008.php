...
class PengaduanController extends Controller
{
    ...
    {
        $pdn = Pengaduan::fiindOrFail($pdn_id);
        ...
        if ($usr_role === 'karyawan') {
            return view('karyawan.pengaduan.edit', compact('title', 'pengajuanSuratTugas'), ['users' => $user, 'pst' => $pst]);
        } elseif ($usr_role === 'admin') {
            return view('admin.pengaduan.edit', compact('title', 'pengajuanSuratTugas'), ['users' => $user, 'pst' => $pst]);
        } else {
            // Handle jika peran tidak teridentifikasi
            return abort(403, 'Unauthorized action.');
        }
