...
class HakPatenController extends Controller
{
    ...
    {
        $hakPaten = HakPaten::first(); // Sesuaikan ini dengan logika atau filter yang sesuai

        // Jika Anda memiliki relasi antara HakPaten dan Pengguna, Anda dapat mengakses pengguna seperti ini:
        $pengguna = $hakPaten->pengguna; // Sesuaikan ini dengan nama relasi yang sesuai

        return view('karyawan.publikasi.hakpaten.create', compact('pengguna'));
    }
