...
class PengabdianMasyarakatController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(UpdatePengabdianMasyarakatRequest $request, PengabdianMasyarakat $pengabdianMasyaraka, $pkm_idt)
    {
        $validatedData = $request->validated();
        ...
        if ($request->hasFile('pkm_buktipendukung')) {
            ...
            if ($pengajuanSuratTugas->pst_buktipendukung && file_exists($pengajuanSuratTugas->pkm_buktipendukung)) {
