...
class HakPatenController extends Controller
{
    ...
    public function index()
    {
        ...
        $user = Pengguna::pluck('pgn_nama'); // Sesuaikan dengan nama kolom di tabel Pengguna

        return view ('karyawan.publikasi.hakpaten.index',  ['hakpaten' => $hakPaten, 'penggunas' => $user]);
    }
    ...
    public function create()
    {
        ...
        $user = Pengguna::pluck('pgn_nama', 'pgn_id'); // Sesuaikan dengan nama kolom di tabel Pengguna

        // Kemudian, kirim data pengguna ke view
        return view('karyawan.publikasi.hakpaten.create', ['penggunas' => $user]);
    }
