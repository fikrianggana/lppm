...
class PengabdianMasyarakatController extends Controller
{
    ...
    public function index()
    {
        ...
        $users = User::pluck('pgn_nama');

        return view ('karyawan.pengabdian.index',  ['pengabdian' => $pengabdianMasyarakat, 'prodis' => $prodis, 'Users' => $users]);
    }
    ...
    public function create()
    {
        ...
        return view('karyawan.pengabdian.create', ['prodis' => $prodis, 'Users' => $users]);
    }
