...
class ProdiController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(UpdateProdiRequest $request, Prodi $prodi, $id)
    {
        try {
            $dataToUpdate = $request->validated(); // Menggunakan validated() dari form request

            Prodi::find($id)->update($dataToUpdate->all());
