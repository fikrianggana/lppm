    ...
    public function confirm($pdn_id)
    {
        try {
            ...
            if ($pengaduan->status == 1) {
                ...
                return redirect()->route('admin.pengaduan.index')->with('success', 'Pengajuan confirmed successfully');
            } else {
                return redirect()->route('admin.pengaduan.index')->with('error', 'Pengajuan has already been confirmed or rejected');
            }
        } catch (\Exception $e) {
