...
class PengabdianMasyarakatController extends Controller
{
    ...
    public function store(StorePengabdianMasyarakatRequest $request)
    {
        ...
        PengabdianMasyarakat::create([
            ...
            'pkm_namakegiatan' => $request->pkm_id,
            'pkm_waktupelaksanaan' => $request->pkm_id,
            'pkm_personilterlibat' => $request->pkm_id,
            'pkm_jumlahpenerimamanfaat' => $request->pkm_id,
            'pkm_buktipendukung' => $request->pkm_id,
        ]);
