...
class PengabdianMasyarakatController extends Controller
{
    ...
    public function index()
    {
        ...
        $users = Pengguna::pluck('pgn_nama');

        return view ('karyawan.pengabdian.index',  ['pengabdian' => $pengabdianMasyarakat, 'prodis' => $prodis, 'penggunas' => $users]);
    }
    ...
    public function create()
    {
        ...
        return view('karyawan.pengabdian.create', ['prodis' => $prodis, 'penggunas' => $users]);
    }
