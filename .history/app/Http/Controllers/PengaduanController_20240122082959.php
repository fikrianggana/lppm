...
class PengaduanController extends Controller
{
    ...
    public function create()
    {
        ...
        $pengaduan = new Pengaduan([
            'usr_id' => auth()->id(), // Contoh: menyimpan ID pengguna yang sedang login
            'pdn_tipe' => $request->input('pdn_tipe'),
            'pdn_jenis' => $request->input('pdn_jenis'),
    ...
    public function getData(Request $request) {
        ...
        if ($pengaduan == "Buku") {
            ...
            $data = [
                ['id' => 1, 'nama' => 'Contoh Data 1'],
                ['id' => 2, 'nama' => 'Contoh Data 2'],
