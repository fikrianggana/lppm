...
{
    // Memanggil method validatedData tanpa tanda kurung
    $validatedData = $request->validatedData();

    // Menyaring data yang akan disimpan
    $dataToStore = $request->only([
        'prd_nama', 'field2', 'field3',  // Gantilah field1, field2, dst dengan field yang sesuai
    ]);

    // Menggunakan try-catch untuk menangani kesalahan penyimpanan data
    try {
