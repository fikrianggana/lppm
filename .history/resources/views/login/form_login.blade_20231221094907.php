...
@section('content') <!-- Mulai bagian konten yang akan dimasukkan ke dalam template utama -->
    ...
    <form action="{{ route(' Route::get('/', [LoginController::class, 'index']);
    Route::post('/login', [LoginController::class, 'login']);') }}" method="POST" autocomplete="off">
        @csrf
        <div class="polman-form-login">
            ...
            {{--  <!-- Add the following reCAPTCHA widget -->
            <div class="form-group">
                <div class="g-recaptcha" data-sitekey="{{ config('services.recaptcha.sitekey') }}"></div>
            </div>  --}}

            <button type="submit" class="btn btn-primary"style="width: 100%; margin-top: 10px; margin-bottom: 10px;">Masuk</button>
