                            ...
                            <tbody>
                                ...
                                @forelse ($hakpaten as $index => $hpt)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ \Carbon\Carbon::parse($hpt->hpt_tglpelaksanaan)->format('d-F-Y') }}</td>
                                        <td class="text-center">{{ $hpt-> }}</td>
    ...
    <script>
        $(document).ready(function() {
            $('.detail-button').on('click', function() {
                ...
                $('#modal-detail').find('#tglPel').text(tglpelaksanaan);
