                                ...
                                @forelse ($hakpaten as $index => $hpt)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <!-- Delete Button -->
                                            <a href="{{ route('admin.publikasi.hakpaten.destroy', ['hpt_id' => $hpt->htp_id]) }}"
                                             ...
                                             <form id="delete-form-{{ $hpt->hpt_id }}" action="{{ route('admin.publikasi.hakpaten.destroy', ['hpt_id' => $bk->bku_id]) }}" method="POST" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
