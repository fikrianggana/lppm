                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="number" class="form-control" name="hpt_nopemohonan" value="{{ old('hpt_nopemohonan')}}" placeholder="Waktu Pelaksanaan">
                                </div>
                                <br>
                                <div class="col-12">
                                    <label class="form-label">Tanggal Pelaksanaan</label>
                                    <input type="date" class="form-control" name="hpt_tglpelaksanaan" value="{{ old('hpt_tglpelaksanaan')}}" placeholder="Orang Yang Terlibat">
                                </div>
                                <br>
                                <div class="col-12">
                                    <label class="form-label">Tanggal Penerima</label>
                                    <input type="date" class="form-control" name="hpt_tglpenerimaan" value="{{ old('hpt_tglpenerimaan')}}" placeholder="Jumlah Penerima Manfaat">
                                </div>
                                <br>
                                {{--  <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="hpt_status" value="{{ old('hpt_status')}}" placeholder="Jumlah Penerima Manfaat">
                                </div>
                                <br>
                                <div class="col-12">
                                    <label class="form-label">Pengguna</label>
                                    <input type="text" class="form-control" name="pgn_id" value="{{ old('hpt_status')}}" placeholder="Jumlah Penerima Manfaat">
                                </div>
                            </div>
                            <br>
                            </div>
