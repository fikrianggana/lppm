                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="number" class="form-control" name="pro_waktuterbit" value="{{ old('pro_waktuterbit')}}" placeholder="Waktu Terbit">
                                </div>
                                <br>
                                <div class="col-12">
...
<div class="col-12">    <label class="form-label">Halaman Awal</label>    <input type="number" class="form-control" name="jrn_halamanawal" value="{{ old('jrn_halamanawal')}}" placeholder="Halaman Awal"></div><br><div class="col-12">    <label class="form-label">Halaman Akhir</label>    <input type="text" class="form-control" name="jrn_halamanakhir" value="{{ old('jrn_halamanakhir')}}" placeholder="Halaman Akhir"></div><br><div class="col-12">    <label class="form-label">URL</label>    <input type="link" class="form-control" name="jrn_url" value="{{ old('jrn_url')}}" placeholder="URL"></div><br><div class="col-12">    <label class="form-label">Kategori</label>    <input type="link" class="form-control" name="jrn_kategori" value="{{ old('jrn_kategori')}}" placeholder="Kategori"></div><br>
                                <div class="col-12">
