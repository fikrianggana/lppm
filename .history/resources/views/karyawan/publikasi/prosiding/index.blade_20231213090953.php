                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="" id="detail-{{ $pro->hpt_id }}" class="btn btn-default detail-button"
                                                ...
                                                data-kat="{{ $pro->pro_kategori }}"
                                                data-penye="{{ $pro->pro_penyelenggara }}"
                                                data-wkt="{{ \Carbon\Carbon::parse($pro->pro_waktuterbit)->format('d-F-Y') }}"
                                                data-tmpt="{{ $pro->pro_tempatpelaksanaan }}"
                                                data-tmpt="{{ $pro->pro_keterangan }}"
