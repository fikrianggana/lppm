    ...
    <script>
        $(document).ready(function() {
            $('.detail-button').on('click', function() {
                ...
                $('#modal-detail').find('#jdprograml').text(pgrm);
                $('#modal-detail').find('#no').text(ppr);
                $('#modal-detail').find('#tglPen').text(kat);
                $('#modal-detail').find('#status').text(penye);
                $('#modal-detail').find('#pengguna').text(tmpt);
                $('#modal-detail').find('#pengguna').text(ket);
