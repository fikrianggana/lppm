                            ...
                            <tbody>
                                ...
                                @forelse ($prosiding as $index => $pro)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $pro->hpt_juduao }}</td>
                                        <td class="text-center">{{ $pro->hpt_nopemohonan }}</td>
                                        <td class="text-center">{{ \Carbon\Carbon::parse($pro->hpt_tglpenerimaan)->format('d-F-Y') }}</td>
                                        <td class="text-center">{{ $pro->hpt_status }}</td>
