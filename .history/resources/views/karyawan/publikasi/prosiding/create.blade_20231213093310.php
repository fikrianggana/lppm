                            ...
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    ...
                                    <select name="pkm_jenis" class="form-control form-control-line" required>
                                        ...
                                        <option value="UMKM" @if(old('pro_kategori') == 'Prosiding Nasional') selected @endif>Prosiding Nasional</option>
                                        <option value="rosiding Internasional" @if(old('pro_kategori') == 'Prosiding Internasional') selected @endif>Prosiding Internasional</option>
                                    </select>
                                </div>
                                <br>
                                <div class="col-12">
