                                ...
                                @forelse ($hakcipta as $index => $hcp)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="" id="detail-{{ $hpt->hcp_id }}" class="btn btn-default detail-button"
                                                data-toggle="modal" data-target="#modal-detail"
                                                data-nama="{{ $hpt->hcp_namalengkap }}"
                                                data-judul="{{ $hpt->hcp_judul }}"
                                                data-nopemohonan="{{ $hpt->hcp_noapk }}"
                                                data-status="{{ $hpt->hcp_sertifikat }}"
                                                data-pengguna="{{ $hpt->hcp_keterangan }}">
