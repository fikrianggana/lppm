                            ...
                            <tbody>
                                ...
                                @forelse ($hakcipta as $index => $hcp)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $hcp->hpt_namalengkap }}</td>
                                        <td class="text-center">{{ $hcp->hpt_judul }}</td>
                                        <td class="text-center">{{ $hcp->hpt_nopemohonan }}</td>
                                        <td class="text-center">{{ \Carbon\Carbon::parse($hpt->hpt_tglpenerimaan)->format('d-F-Y') }}</td>
                                        <td class="text-center">{{ $hcp->hpt_status }}</td>
                                        <td class="text-center">{{ $hcp->pgn_id }}</td>
