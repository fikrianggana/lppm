...
<body>
    ...
    <main id="main" class="main">
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <form method="post" action="{{ route ('karyawan.publikasi.hakcipta.store')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="date" class="form-control" name="hcp_sertifikat" value="{{ old('hcp_sertifikat')}}" placeholder="Tanggal Pelaksanaan">
                                </div>
                                <br>
                                <div class="col-12">
                                    <label class="form-label">Keterangan</label>
                                    <input type="date" class="form-control" name="hcp_keterangan" value="{{ old('hpt_tglpenerimaan')}}" placeholder="Tanggal Penerima">
                                </div>
                                <br>
                                {{--  <div class="col-12">
