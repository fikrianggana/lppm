        ...
        <script>
            $(document).ready(function() {
                $('.detail-button').on('click', function() {
                    ...
                    var namapersonil = $(this).data('waktupelaksanaan');
                    var issn = $(this).data('personilterlibat');
                    var volume = $(this).data('jumlahpenerimamanfaat');
                    var nomor = $(this).data('buktipendukung');
