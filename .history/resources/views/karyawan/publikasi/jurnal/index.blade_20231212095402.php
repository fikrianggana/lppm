                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="" id="detail-{{ $jrn->jrn_id }}" class="btn btn-default detail-button"
                                                ...
                                                data-judul="{{ $pkm->pkm_namakegiatan }}"
                                                data-nama="{{ $pkm->pkm_jenis }}"
                                                data-namapersonal="{{ \Carbon\Carbon::parse($pkm->pkm_waktupelaksanaan)->format('d-F-Y') }}"
                                                data-issn="{{ $pkm->pkm_personilterlibat }}"
                                                data-volume="{{ $pkm->pkm_jumlahpenerimamanfaat }}"
                                                data-nomor="{{ $pkm->pkm_buktipendukung }}">
