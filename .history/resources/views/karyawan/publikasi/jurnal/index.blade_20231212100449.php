        ...
        <script>
            $(document).ready(function() {
                $('.detail-button').on('click', function() {
                    ...
                    var halamanawal = $(this).data('nomor');
                    var halamanakhir = $(this).data('nomor');
                    var url = $(this).data('nomor');
                    var kategori = $(this).data('nomor');
                    var pengguna = $(this).data('nomor');
                    var atribut = $(this).data('nomor');
