                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="" id="detail-{{ $jrn->jrn_id }}" class="btn btn-default detail-button"
                                                ...
                                                data-judul="{{ $jrn->jrn_namakegiatan }}"
                                                data-nama="{{ $jrn->jrn_jenis }}"
                                                data-namapersonal="{{ \Carbon\Carbon::parse($jrn->jrn_waktupelaksanaan)->format('d-F-Y') }}"
                                                data-issn="{{ $jrn->jrn_personilterlibat }}"
                                                data-volume="{{ $jrn->jrn_jumlahpenerimamanfaat }}"
                                                data-nomor="{{ $jrn->jrn_buktipendukung }}">
