        ...
        <script>
            $(document).ready(function() {
                $('.detail-button').on('click', function() {
                    ...
                    $('#modal-detail').find('#jdl').text(nama);
                    $('#modal-detail').find('#nama').text(jenis);
                    $('#modal-detail').find('#namapersonil').text(waktupelaksanaan);
                    $('#modal-detail').find('#issn').text(personilterlibat);
                    $('#modal-detail').find('#volume').text(jumlahpenerimamanfaat);
                    $('#modal-detail').find('#nomor').text(jumlahpenerimamanfaat);
                    $('#modal-detail').find('#halamanawal').text(jumlahpenerimamanfaat);
                    $('#modal-detail').find('#halamanakhir').text(jumlahpenerimamanfaat);
                    $('#modal-detail').find('#url').text(jumlahpenerimamanfaat);
                    $('#modal-detail').find('#kategori').text(jumlahpenerimamanfaat);
                    $('#modal-detail').find('#pengguna').text(jumlahpenerimamanfaat);
                    $('#modal-detail').find('#atribut').text(jumlahpenerimamanfaat);
