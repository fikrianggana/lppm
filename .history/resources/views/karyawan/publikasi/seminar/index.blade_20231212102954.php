        ...
        <script>
            $(document).ready(function() {
                $('.detail-button').on('click', function() {
                    ...
                    $('#modal-detail').find('#kategori').text(jenis);
                    $('#modal-detail').find('#penyelenggara').text(waktupelaksanaan);
                    $('#modal-detail').find('#waktu').text(personilterlibat);
                    $('#modal-detail').find('#tempat').text(jumlahpenerimamanfaat);
