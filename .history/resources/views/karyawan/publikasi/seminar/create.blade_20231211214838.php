                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="number" class="form-control" name="pgn_id" value="{{ old('pgn_id')}}" placeholder="Pengguna">
                                </div>
                                <br>
                                <div class="col-12">
                                    <label class="form-label">Atribut</label>
                                    <input type="text" class="form-control" name="smn_atribut" value="{{ old('jrn_halamanakhir')}}" placeholder="Halaman Akhir">
                                </div>
                                <br>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <label class="form-label">Pengguna</label>
                                    <input type="link" class="form-control" name="pgn_id" value="{{ old('pgn_id')}}" placeholder="Pengguna">
                                </div>
                                <br>
                                <div class="col-12">
                                    <label class="form-label">Atribut</label>
                                    <input type="link" class="form-control" name="jrn_atribut" value="{{ old('jrn_atribut')}}" placeholder="Atribut">
                                </div>
                            </div>
                            <br>
                            </div>
