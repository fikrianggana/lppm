                            ...
                            <tbody>
                                ...
                                @forelse ($seminar as $index => $smn)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $smn->smn_waktu }}{{ \Carbon\Carbon::parse($pkm->pkm_waktupelaksanaan)->format('d-F-Y') }}{{ \Carbon\Carbon::parse($pkm->pkm_waktupelaksanaan)->format('d-F-Y') }}</td>
