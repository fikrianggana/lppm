                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="" id="detail-{{ $sn->smn_id }}" class="btn btn-default detail-button"
                                                ...
                                                data-nama="{{ $smn->smn_namakegiatan }}"
                                                data-jenis="{{ $smn->smn_jenis }}"
                                                data-waktupelaksanaan="{{ \Carbon\Carbon::parse($smn->smn_waktupelaksanaan)->format('d-F-Y') }}"
                                                data-personilterlibat="{{ $smn->smn_personilterlibat }}"
