          ...
          <div class="row">
              <div class="col-lg-12">
                  ...
                  <br>
                          ...
                          <table  id="tbl_buku" class="table table-hover table-bordered table-condensed table-striped grid">
                              <thead>
                                  <tr>
...
<script>
    $(document).ready(function() {
        var dataTableVendor = $('#data-table-vendor').DataTable();

        // Mendengarkan perubahan input pencarian DataTable
        dataTableVendor.on('search.dt', function() {
            var searchKeyword = dataTableVendor.search();
            // Tombol "Export PDF" akan mengarahkan ke functionExportPdf.php dengan kata kunci pencarian
            $('#export-pdf-button').attr('href', 'tb_vendor/functionExportPdf.php?search_keyword=' + searchKeyword);
        });
    });
</script>
@endsection
