                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="bku_judul" value="{{ old('hpt_judul')}}" placeholder="Judul">
                                </div>
                                {{--  <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="bku_penulis" value="{{ old('hpt_nopemohonan')}}" placeholder="No Pemohonan">
                                </div>
                                <br>
                                <div class="col-12">
                                    <label class="form-label">Nama Editor</label>
                                    <input type="date" class="form-control" name="bku_editor" value="{{ old('hpt_tglpelaksanaan')}}" placeholder="Tanggal Pelaksanaan">
                                </div>
                                <br>
                                <div class="col-12">
                                    <label class="form-label">ISBN</label>
                                    <input type="date" class="form-control" name="bku_isbn" value="{{ old('hpt_tglpenerimaan')}}" placeholder="Tanggal Penerima">
                                </div>
                                <br>
                                {{--  <div class="col-12">
