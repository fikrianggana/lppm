...
<script>
    $(document).ready(function() {
        $('.detail-button').on('click', function() {
            ...
            var pnrn = $(this).data('penerbit');
            var pengguna = $(this).data('tahun');

            // Menampilkan data dalam modal
            $('#modal-detail').find('#judul').text(nama);
            $('#modal-detail').find('#penulis').text(judul);
            $('#modal-detail').find('#editor').text(nopemohonan);
            $('#modal-detail').find('#isbn').text(tglpenerimaan);
            $('#modal-detail').find('#penerbit').text(status);
            $('#modal-detail').find('#tahun').text(pengguna);
