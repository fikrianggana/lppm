                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="bku_penulis" value="{{ old('bku_penulis')}}" placeholder="No Pemohonan">
                                </div>
                                <br>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="bku_tahun" value="{{ old('hpt_status')}}" placeholder="Status">
                                </div>
                                <br>
                                <div class="col-12">
