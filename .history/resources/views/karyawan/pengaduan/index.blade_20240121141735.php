                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="" id="detail-{{ $pdn->pdn_id }}" class="btn btn-default detail-button"
                                                ...
                                                data-jenis="{{ $pdn->pdn_namasurattugas }}"
                                            ...
                                            <!-- Delete Button -->
                                            @if($pdn->status == 0)
                                                <a href="{{ route('karyawan.pengajuan.destroy', ['pdn_id' => $pdn->pdn_id]) }}"
                                            ...
                                            <form id="delete-form-{{ $pdn->pdn_id }}" action="{{ route('karyawan.pengajuan.destroy', ['pdn_id' => $pdn->pdn_id]) }}" method="POST" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </td>
