                              ...
                              <tbody>
                                 ...
                                 @forelse ($pengaduan as $index => $pdn)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @if ($pdn->status === 0)
                                                <a href="{{ route('karyawan.pengaduan.kirim', $pdn->pst_id) }}" class="btn btn-default">  <i class="fa fa-paper-plane" aria-hidden="true"></i></a>
                                            @endif

                                            @if ($pdn->status === 0)
                                                <a href="{{ route('karyawan.pengaduan.edit', ['pst_id' => $pst->pst_id]) }}" class="btn btn-default">
