          ...
          <div class="row">
              <div class="col-lg-12">
                    ...
                    <br>
                        ...
                        <p>
                        <a class="btn btn-primary" href="{{ route('karyawan.pengaduan.create') }}"><i class="fa fa-plus" aria-hidden="true"></i>   Tambah Pengajuan Surat Tugas</a>
                        </p>
                            ...
                            <div class="col-lg-12">
                                <div class="input-group w-100">
                                    ...
                                    <div class="text-right">
                                        <a class="btn btn-success" href="{{ route('karyawan.pengaduan.export') }}">
...
<script>
    $(document).ready(function() {
        $('.detail-button').on('click', function() {
            ...
            $('#modal-detail').find('#jns').text(status);
            $('#modal-detail').find('#waktu').text(keterangan);
...
<script>
    $(document).ready(function() {
        ...
        $('.feedback-button').on('click', function() {
            var pdnId = $(this).data('pdnid');
            var feedbackUrl = '{{ route("admin.pengaduan.kirim", ["pdn_id" => ":pdn_id"]) }}'.replace(':pdn_id', pdnId);
        ...
        $('#feedback-action').on('click', function(e) {
            ...
            $.ajax({
                ...
                processData: false,
                success: function(response) {
                    console.log('Pengaduan berhasil dikirim.');
                    window.location.reload();
                },
                error: function(error) {
                    console.error('Error mengirim Pengaduan:', error.responseJSON.error);
