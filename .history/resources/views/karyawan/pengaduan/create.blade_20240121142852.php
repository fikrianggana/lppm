                            ...
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    ...
                                    <select name="pdn_jenis" class="form-control form-control-line" required>
                                        ...
                                        <option value="Buku" @if(old('pdn_jenis') == 'Hapus') selected @endif>Hapus </option>
                                        <option value="Jurnal" @if(old('pdn_jenis') == 'Hapus') selected @endif>Hapus </option>
                                        <option value="Seminar" @if(old('pdn_jenis') == 'Hapus') selected @endif>Hapus </option>
                                        <option value="Hak Cipta" @if(old('pdn_jenis') == 'Hapus') selected @endif>Hapus </option>
                                        <option value="Hak Paten" @if(old('pdn_jenis') == 'Hapus') selected @endif>Hapus </option>
                                        <option value="Prosiding" @if(old('pdn_jenis') == 'Hapus') selected @endif>Hapus </option>
                                    </select>
                                </div>
                                <br>
                                <div class="col-12">
