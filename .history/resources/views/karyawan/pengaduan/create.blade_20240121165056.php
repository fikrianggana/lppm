                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    ...
                                    <select name="pdn_tipe" class="form-control form-control-line" id="jenisPengaduan" required>
...
<script>
    // Handle the change event of the jenisPengaduan dropdown
    document.getElementById('jenisPengaduan').addEventListener('change', function () {
        var selectedType = this.value;

        // Make an AJAX request to get data based on the selected type
        axios.get('/get-data/' + selectedType)
            .then(function (response) {
                var databreSelect = document.getElementById('databre');
                databreSelect.innerHTML = ""; // Clear existing options

                // Populate options based on the retrieved data
                response.data.forEach(function (item) {
                    var option = document.createElement('option');
                    option.value = item.bku_id; // Set the appropriate value for your case
                    option.text = item.bku_judul; // Set the appropriate property for your case
                    databreSelect.add(option);
                });
            })
