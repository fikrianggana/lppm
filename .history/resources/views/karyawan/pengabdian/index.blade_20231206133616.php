                                 ...
                                 @forelse ($pengabdian as $pkm)
                                     <tr>
                                        ...
                                        <td>{{$pkm->pkm_buktipendukung}}</td>
                                         ...
                                         <td>
                                            <a href="{{ route('karyawan.pengabdian.edit', ['pkm_id' => $pkm->pkm_id]) }}" class="btn btn-secondary btn-sm btn-warning">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a href="#" class="btn btn-sm btn-danger" onclick="confirmDelete('{{ $pkm->pkm_id }}')">
