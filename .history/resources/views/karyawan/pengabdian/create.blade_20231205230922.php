                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="sku" value="{{ old('pkm_namakegiatan')}}" placeholder="#SKU">
                                </div>
                                <br>
                                <div class="col-12">
                                    <label class="form-label">Jenis Pengabdian</label>
                                    <input type="text" class="form-control" name="name" value="{{ old('pkm_jenis')}}" placeholder="Name">
                                </div>
                                <br>
                                <div class="col-12">
