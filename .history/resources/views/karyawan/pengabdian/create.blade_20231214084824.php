            ...
            <div class="row">
                <div class="col-lg-12">
                    <form method="post" action="{{ route ('karyawan.pengabdian.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="col-12">
                        <button href="{{ route('karyawan.form_login.index') }}" type="cancel" class="btn btn-secondary">Batal</button>
...
<script>
    ...
    document.querySelector('form').addEventListener('submit', function (e) {
        ...
        var prodiValue = document.querySelector('[name="prd_id"]').value;
    ...
    document.querySelector('[name="prd_id"]').addEventListener('change', function (e) {
