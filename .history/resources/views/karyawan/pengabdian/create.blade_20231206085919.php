            ...
            <div class="row">
                <div class="col-lg-12">
                    <form method="post" action="{{ route ('karyawan.pengabdian.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">New Pengabdian</h5>
                                <hr />
                                @if ($errors -> any())
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="pkm_waktupelaksanaan" value="{{ old('pkm_waktupelaksanaan')}}" placeholder="Waktu Pelaksanaan">
                                </div>
                                <br>
                                <div class="col-12">
