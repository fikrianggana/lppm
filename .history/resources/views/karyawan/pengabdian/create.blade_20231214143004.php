...
<body>
    ...
    <main id="main" class="main">
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <form method="post" action="{{ route ('karyawan.pengabdian.store')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    <label class="form-label">Nama Mahasiswa</label>
                                    @for ($i = 0; $i < 2; $i++) <!-- Change 2 to the desired number of inputs -->
                                        <input type="text" class="form-control" name="pkm_mahasiswa[]" value="{{ old('pkm_mahasiswa.' . $i) }}" placeholder="Nama Mahasiswa">
                                    @endfor
                                    <button id="Mhs" type="button">Kirim</button>
                                </div>
                                <br>
                                <div class="col-12">
                                    <label class="form-label">NIM Mahasiswa</label>
                                    @for ($i = 0; $i < 2; $i++) <!-- Change 2 to the desired number of inputs -->
                                        <input type="number" class="form-control" name="pkm_nim[]" value="{{ old('pkm_nim.' . $i) }}" placeholder="NIM Mahasiswa">
                                    @endfor
                                    <button id="nm" type="button">Kirim</button>
                                </div>
                                <div class="col-12">
