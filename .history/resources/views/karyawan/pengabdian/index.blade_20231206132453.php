                                 ...
                                 @forelse ($pengabdian as $pkm)
                                     <tr>
                                         ...
                                         <td>
                                            ...
                                            <a href="#" class="btn btn-sm btn-danger fas fa-trash" onclick="confirmDelete('{{ $pkm->id }}')"></a>
                                            <form id="delete-row-{{ $pkm->id }}" action="{{ route('karyawan.pengabdian.destroy', ['pkm_id'=>$pkm->id]) }}" method="POST" style="display: none;">
