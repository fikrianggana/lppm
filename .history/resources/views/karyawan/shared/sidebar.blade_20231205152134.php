...
<div class="polman-nav-static-right collapse scrollstyle" id="menu">
    <div id="accordions" role="tablist" aria-multiselectable="true">
        <div class="list-group">
            ...
            <!-- Add an id to Publikasi link -->
<a href='{{ route ('karyawan.publikasi.index') }}' id='publikasi-link' class='list-group-item list-group-item-action'
    style='border-radius: 0px; border: none; padding-left: 22px; display: inherit;'>
    <i class="fa-solid fa-people-roof"></i>Publikasi
</a>

<!-- Submenu items for Publikasi -->
<div id="publikasi-submenu" class="submenu" style="display: none;">
