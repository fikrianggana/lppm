...
<div class="polman-nav-static-right collapse scrollstyle" id="menu">
    <div id="accordions" role="tablist" aria-multiselectable="true">
        <div class="list-group">
            ...
            <!-- Add a new menu item with a dropdown -->
            <div class="dropdown">
                <a href="#" class='list-group-item list-group-item-action dropdown-toggle'
                    style='border-radius: 0px; border: none; padding-left: 22px; display: inherit;' id="publikasiDropdown" role="button"
                ...
                <div class="dropdown-menu" aria-labelledby="publikasiDropdown">
                    ...
                    <a class="dropdown-item" href="#">Hak Paten</a>
                </div>
            </div>
