    ...
    <div id="accordions" role="tablist" aria-multiselectable="true">
        <div class="list-group">
            ...
            <a class='list-group-item list-group-item-action'
                ...
                <i class="fas fa-newspaper-o fa-solid fa-people-roof"></i>Publikasi
            </a>
