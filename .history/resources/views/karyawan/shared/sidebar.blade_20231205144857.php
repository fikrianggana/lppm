    ...
    <div id="accordions" role="tablist" aria-multiselectable="true">
        <div class="list-group">
            ...
            <a href='{{ route ('karyawan.pengabdian.index') }}' class='list-group-item list-group-item-action'
                style='border-radius: 0px; border: none; padding-left: 22px; display: inherit;'>
                <i class="fa fa-flag fa-lg fa-pull-left fa-solid fa-people-roof"></i>Pengabdian Masyakarat
            </a>

            <a href='{{ route ('karyawan.pengajuan.index') }}' class='list-group-item list-group-item-action'
                style='border-radius: 0px; border: none; padding-left: 22px; display: inherit;'>
                <i class="fa-solid fa-people-roof"></i>Pengajuan Surat Tugas
            </a>

            <a href='{{ route ('karyawan.publikasi.index') }}' class='list-group-item list-group-item-action'
                style='border-radius: 0px; border: none; padding-left: 22px; display: inherit;'>
                <i class="fa-solid fa-people-roof"></i>Publikasi
            </a>

            <!-- Submenu items for Publikasi -->
            {{--  <div class="submenu">
                <a href='{{ route ('karyawan.publikasi.buku') }}' class='list-group-item list-group-item-action'
                    style='border-radius: 0px; border: none; padding-left: 40px; display: inherit;'>
                    Buku
                </a>
                <a href='{{ route ('karyawan.publikasi.jurnal') }}' class='list-group-item list-group-item-action'
                    style='border-radius: 0px; border: none; padding-left: 40px; display: inherit;'>
                    Jurnal
                </a>
                <a href='{{ route ('karyawan.publikasi.seminar') }}' class='list-group-item list-group-item-action'
                    style='border-radius: 0px; border: none; padding-left: 40px; display: inherit;'>
                    Seminar
                </a>
                <a href='{{ route ('karyawan.publikasi.hakcipta') }}' class='list-group-item list-group-item-action'
                    style='border-radius: 0px; border: none; padding-left: 40px; display: inherit;'>
                    Hak Cipta
                </a>
                <a href='{{ route ('karyawan.publikasi.hakpaten') }}' class='list-group-item list-group-item-action'
                    style='border-radius: 0px; border: none; padding-left: 40px; display: inherit;'>
                    Hak Paten
                </a>
            </div>  --}}
