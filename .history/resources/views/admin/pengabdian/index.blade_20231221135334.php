                            ...
                            <table class="table table-hover table-bordered table-condensed table-striped grid">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <!-- Delete Button -->
                                        <a href="{{ route('admin.pengabdian.destroy', ['pkm_id' => $pkm->pkm_id]) }}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');"method="PO">
