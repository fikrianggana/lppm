                            ...
                            <table class="table table-hover table-bordered table-condensed table-striped grid">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <!-- Delete Button -->
                                        <a href="{{ route('admin.publikasi.pengabdian.destroy', ['pkm_id' => $pkm->pkm_id]) }}"
                                            ...
                                            <form id="delete-form-{{ $pkm->pkm_id }}" action="{{ route('admin.publikasi.pengabdian.destroy', ['pkm_id' => $pkm->pkm_id]) }}" method="POST" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
