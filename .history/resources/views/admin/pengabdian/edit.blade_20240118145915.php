                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="number" class="form-control" name="pkm_jumlahpenerimamanfaat" value="{{ old('pkm_jumlahpenerimamanfaat', $pkm -> pkm_jumlahpenerimaman)}}" placeholder="Jumlah Penerima Manfaat">
                                </div>
                                <br>
                                <div class="col-12">
