                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="#" class="btn btn-sm btn-danger fas fa-trash" onclick="
                                            ...
                                            document.getElementById('delete-row-{{ $siswa->idsiswa }}').submit();
                                            }">
                                        </a>
                                        <form id="delete-row-{{ $siswa->idsiswa }}" action="{{ route('admin.pengabdian.destroy', ['idsiswa'=>$siswa->idsiswa]) }}" method="POST">
