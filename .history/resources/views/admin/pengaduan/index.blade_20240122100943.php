                              ...
                              <tbody>
                                @forelse ($pengaduan as $index => $pdn)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">{{$pst->pdn_tipe}}</td>
                                        <td class="text-center">{{$pst->pdn_jenis}}</td>
                                        <td class="text-center">{{$pst->keterangan}}</td>

                                        <td class="text-center">
                                            @if ($pdn->status === 1)
                                            <!-- Confirm Button -->
                                            <a href="#" class="btn btn-success confirm-button" data-toggle="modal" data-target="#modal-validation" data-pstid="{{ $pdn->pst_id }}">
