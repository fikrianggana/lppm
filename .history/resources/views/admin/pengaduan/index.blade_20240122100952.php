                                ...
                                @forelse ($pengaduan as $index => $pdn)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @if ($pdn->status === 1)
                                            <!-- Confirm Button -->
                                            <a href="#" class="btn btn-success confirm-button" data-toggle="modal" data-target="#modal-validation" data-pdnid="{{ $pdn->pdn_id }}">
                                            ...
                                            <!-- Reject Button -->
                                            <a href="#" class="btn btn-danger reject-button" data-toggle="modal" data-target="#modal-reject" data-pdnid="{{ $pdn->pdn_id }}">
