...
<script>
    $(document).ready(function() {
        ...
        $('.confirm-button').on('click', function() {
            ...
            var confirmUrl = '{{ route("admin.pengajuan.confirm", ["pdn_id" => ":pdn_id"]) }}'.replace(':pdn_id', pdnId);
        ...
        $('.reject-button').on('click', function() {
            var pdnId = $(this).data('pdnid');
            var rejectUrl = '{{ route("admin.pengajuan.reject", ["pdn_id" => ":pdn_id"]) }}'.replace(':pdn_id', pdnId);
        ...
        $('.feedback-button').on('click', function() {
            var pdnId = $(this).data('pdnid');
            var feedbackUrl = '{{ route("admin.pengajuan.kirim", ["pdn_id" => ":pdn_id"]) }}'.replace(':pdn_id', pdnId);
