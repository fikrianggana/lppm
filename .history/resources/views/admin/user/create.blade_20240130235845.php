                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="usr_role" value="{{ old('usr_role')}}" placeholder="Role">
                                </div>
                                <br>
                                <div class="col-12">
                                    <label class="form-label">Email</label>
                                    <input type="text" class="form-control" name="usr_email" value="{{ old('smn_keterangan')}}" placeholder="Keterangan">
                                </div>
                                <br>
                                <div class="col-12">
