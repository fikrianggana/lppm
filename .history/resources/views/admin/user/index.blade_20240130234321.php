                            ...
                            <tbody>
                                ...
                                @forelse ($user as $index => $usr)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $puro->username }}</td>
                                        <td class="text-center">{{ $pro->usr_role }}</td>
                                        <td class="text-center">{{ $pro->usr_email }}</td>
                                        <td class="text-center">{{ $pro->usr_notelpon }}</td>
