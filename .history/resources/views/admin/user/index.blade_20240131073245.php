                              ...
                              <tbody>
                                 ...
                                 @forelse ($user as $index => $usr)
                                     <tr>
                                        ...
                                        <td class="text-center">{{$usr->usru_penulis}}</td>
                                        <td class="text-center">{{$usr->usru_editor}}</td>
                                        <td class="text-center">{{$usr->usru_isbn}}</td>
                                        <td class="text-center">{{$usr->usru_penerbit}}</td>
                                        <td class="text-center">{{$usr->usru_tahun}}</td>

                                        <td class="text-center">


                                            <a href="{{ route('admin.publikasi.buku.edit', ['usru_id' => $usr->usru_id]) }}" class="btn btn-default">
                                                ...
                                                onclick="event.preventDefault();
                                                        ...
                                                        reverseButtons: true
                                                                ...
                                                                if (result.isConfirmed) {
                                                                    document.getElementById('delete-form-{{ $usr->usru_id }}').submit();
                                            ...
                                            <form id="delete-form-{{ $usr->usru_id }}" action="{{ route('admin.publikasi.buku.destroy', ['usru_id' => $usr->usru_id]) }}" method="POST" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
