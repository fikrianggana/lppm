                                ...
                                @forelse ($user as $index => $usr)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('admin.user.edit', ['user_id' => $usr->user_id]) }}" class="btn btn-default">
                                                <i class="fa fa-edit" aria-hidden="true"></i>
                                            </a>

                                            <!-- Delete Button -->
                                            <form id="delete-form-{{ $usr->usr_id }}" action="{{ route('admin.user.destroy', ['user_id' => $usr->usr_id]) }}" method="POST" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
