                            ...
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    ...
                                    <select name="usr_role" class="form-control form-control-line">
                                        ...
                                        <option value="Prosiding Nasional" @if(old('usr_role') == 'Prosiding Nasional') selected @endif>Prosiding Nasional</option>
                                        <option value="Prosiding Internasional" @if(old('usr_role') == 'Prosiding Internasional') selected @endif>Prosiding Internasional</option>
                                    </select>
                                </div>
                                <br>
                                <div class="col-12">
