                                 ...
                                 @forelse ($user as $index => $usr)
                                     <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{ route('admin.user.edit', ['id' => $usr->usr_id]) }}" class="btn btn-default">
                                            ...
                                            <form id="delete-form-{{ $usr->usr_id }}" action="{{ route('admin.user.destroy', ['id' => $usr->usr_id]) }}" method="POST" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                            ...
                                            <a href="" id="detail-{{ $usr->usr_id }}" class="btn btn-default detail-button"
                                                ...
                                                data-judul="{{ $usr->usr_nama }}"
                                                data-penulis="{{ $usr->prodi_id }}"
                                                data-editor="{{ $usr->username }}"
                                                data-isbn="{{ $usr->usr_role }}"
                                                data-penerbit="{{ $usr->usr_email }}"
                                                data-tahun="{{$usr->usr_notelpon}}">
