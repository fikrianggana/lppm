            ...
            <section class="section">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p>
                            <a class="btn btn-primary" href="{{ route('admin.prosiding.create') }}"><i class="fa fa-plus" aria-hidden="true"></i> Tambah Prosiding</a>
                        </p>
                        ...
                        <div class="row">
                                <div class="col-lg-12">
                                    <div class="input-group w-100">
                                        <!-- Search Form -->
                                        <form action="{{ route('admin.publikasi.prosiding.index') }}" method="GET" class="form-inline w-100">
