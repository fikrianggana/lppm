                            ...
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    ...
                                    <select name="jrn_kategori" class="form-control form-control-line">
                                        ...
                                        <option value="Jurnal Nasional Terakreditasi Sinta 2" @if(old('jrn_kategori') == 'Juara Nasional Terakreditasi Sinta 2') selected @endif>PJuara Nasional Terakreditasi Sinta 2</option>
