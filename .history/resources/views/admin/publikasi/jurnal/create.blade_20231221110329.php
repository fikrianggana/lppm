                            ...
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    ...
                                    <select name="jrn_kategori" class="form-control form-control-line">
                                        <option value="">Pilih Salah Satu</option>
                                        <option value="Jurnal Nasional Tidak Terakreditasi" @if(old('jrn_kategori') == 'Jurnal Nasional Tidak Terakreditasi') selected @endif>Juara Nasional Tidak Terad</option>
                                        <option value="Jurnal Nasional Terakreditasi Sinta 2" @if(old('jrn_kategori') == 'Juara Nasional Terakreditasi Sinta 2') selected @endif>Prosiding Internasional</option>
                                        <option value="Jurnal Nasional Terakreditasi Sinta 3" @if(old('jrn_kategori') == 'Juara Nasional Terakreditasi Sinta 3') selected @endif>Prosiding Internasional</option>
                                        <option value="Jurnal Nasional Terakreditasi Sinta 4" @if(old('jrn_kategori') == 'Juara Nasional Terakreditasi Sinta 4') selected @endif>Prosiding Internasional</option>
                                        <option value="Jurnal Nasional Terakreditasi Sinta 5" @if(old('jrn_kategori') == 'Juara Nasional Terakreditasi Sinta 5') selected @endif>Prosiding Internasional</option>
                                    </select>
                                </div>
                                <br>
                                <div class="col-12">
