                            ...
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    ...
                                    <select name="jrn_kategori" class="form-control form-control-line">
                                        <option value="">Pilih Salah Satu</option>
                                        <option value="Prosiding Nasional" @if(old('jrn_kategori') == 'Prosiding Nasional') selected @endif>Prosiding Nasional</option>
                                        <option value="Prosiding Internasional" @if(old('jrn_kategori') == 'Prosiding Internasional') selected @endif>Prosiding Internasional</option>
                                    </select>
                                </div>
                                <br>
                                <div class="col-12">
