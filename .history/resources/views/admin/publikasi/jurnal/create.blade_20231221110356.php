                            ...
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    ...
                                    <select name="jrn_kategori" class="form-control form-control-line">
                                        ...
                                        <option value="Jurnal Nasional Terakreditasi Sinta 3" @if(old('jrn_kategori') == 'Juara Nasional Terakreditasi Sinta 3') selected @endif>Juara Nasional Terakreditasi Sinta 2</option>
                                        <option value="Jurnal Nasional Terakreditasi Sinta 4" @if(old('jrn_kategori') == 'Juara Nasional Terakreditasi Sinta 4') selected @endif>Juara Nasional Terakreditasi Sinta 2</option>
                                        <option value="Jurnal Nasional Terakreditasi Sinta 5" @if(old('jrn_kategori') == 'Juara Nasional Terakreditasi Sinta 5') selected @endif>Juara Nasional Terakreditasi Sinta 2</option>
                                    </select>
                                </div>
                                <br>
                                <div class="col-12">
