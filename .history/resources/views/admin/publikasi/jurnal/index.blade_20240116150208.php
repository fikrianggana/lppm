                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p>
                            ...
                            <a class="btn btn-success" href="{{ route('admin.publikasi.jurnal.export') }}"><i class="fa fa-download" aria-hidden="true"></i>  Export Data</a>
                        </p>
                                ...
                                @forelse ($jurnal as $index => $jrn)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="#" class="btn btn-danger" onclick="event.preventDefault(); if(confirm('Are you sure you want to delete this item?')) { document.getElementById('delete-form-{{ $jrn->jrn_id }}').submit(); }">
