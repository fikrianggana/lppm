...
<body>
    ...
    <main id="main" class="main">
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                <form action="{{ route('admin.publikasi.jurnal.edit', ['jrn_id' => $jrn->jrn_id]) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="jrn_namapersonil" value="{{ old('jrn_namapersonil', $jrn -> jrn_namajrn_namapersoniljurnal)}}" placeholder="Nama Personil">
                                </div>
                                <br>
                                <div class="col-12">
                                    <label class="form-label">ISSN</label>
                                    <input type="number" class="form-control" name="jrn_issn" value="{{ old('jrn_issn', $jrn -> jrn_namajurnal)}}" placeholder="ISSN">
                                </div>
                                <br>
                                <div class="col-12">
                                    <label class="form-label">Volume</label>
                                    <input type="text" class="form-control" name="jrn_volume" value="{{ old('jrn_volume, $jrn -> jrn_namajurnal')}}" placeholder="Volume">
                                </div>
                                <br>
                                <div class="col-12">
                                    <label class="form-label">Nomor</label>
                                    <input type="text" class="form-control" name="jrn_nomor" value="{{ old('jrn_nomor', $jrn -> jrn_namajurnal)}}" placeholder="Nomor">
                                </div>
                                <br>
                                <div class="col-12">
                                    <label class="form-label">Halaman Awal</label>
                                    <input type="number" class="form-control" name="jrn_halamanawal" value="{{ old('jrn_halamanawal', $jrn -> jrn_namajurnal)}}" placeholder="Halaman Awal">
                                </div>
                                <br>
                                <div class="col-12">
                                    <label class="form-label">Halaman Akhir</label>
                                    <input type="text" class="form-control" name="jrn_halamanakhir" value="{{ old('jrn_halamanakhir', $jrn -> jrn_namajurnal)}}" placeholder="Halaman Akhir">
                                </div>
                                <br>
                                <div class="col-12">
                                    <label class="form-label">URL</label>
                                    <input type="link" class="form-control" name="jrn_url" value="{{ old('jrn_url', $jrn -> jrn_namajurnal)}}" placeholder="URL">
                                </div>
                                <br>
                                <div class="col-12">
