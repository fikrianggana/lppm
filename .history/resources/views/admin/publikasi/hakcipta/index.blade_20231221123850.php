                                ...
                                @forelse ($hakcipta as $index => $hcp)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('admin.publikasi.hakcipta.edit', ['jrn_id' => $jrn->jrn_id]) }}" class="btn btn-warning">
                                                <i class="fa fa-edit" aria-hidden="true"></i>
                                            </a>

                                            <!-- Delete Button -->
                                            <a href="{{ route('admin.publikasi.jurnal.destroy', ['jrn_id' => $jrn->jrn_id]) }}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');">
