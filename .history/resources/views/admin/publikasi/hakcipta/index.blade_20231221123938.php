            ...
            <section class="section">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p>
                            <a class="btn btn-primary" href="{{ route('admin.publikasi.hakcipta.create') }}"><i class="fa fa-plus" aria-hidden="true"></i> Tambah Hak Paten</a>
                        </p>
                                ...
                                @forelse ($hakcipta as $index => $hcp)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('admin.publikasi.hakcipta.edit', ['hcp_id' => $jrn->hcp_id]) }}" class="btn btn-warning">
                                                <i class="fa fa-edit" aria-hidden="true"></i>
                                            </a>

                                            <!-- Delete Button -->
                                            <a href="{{ route('admin.publikasi.jurnal.destroy', ['hcp_id' => $hcp_id->jrn_id]) }}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');">
