                                 ...
                                 @forelse ($buku as $index => $bk)
                                     <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('admin.publikasi.buku.edit', ['bku_id' => $bk->hpt_id]) }}" class="btn btn-warning">
                                                    <i class="fa fa-edit" aria-hidden="true"></i>
                                                </a>

                                                <!-- Delete Button -->
                                                <a href="{{ route('admin.publikasi.hakpaten.destroy', ['bku_id' => $hpt->hpt_id]) }}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');">
