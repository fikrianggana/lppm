                                 ...
                                 @forelse ($buku as $index => $bk)
                                     <tr>
                                            ...
                                            <td class="text-center">
                                                a href="{{ route('admin.pengabdian.edit', ['bku_id' => $bku->bku_id]) }}" class="btn btn-warning">
                                                    <i class="fa fa-edit" aria-hidden="true"></i>
                                                </a>

                                                <!-- Delete Button -->
                                                <a href="{{ route('admin.pengabdian.destroy', ['bku_id' => $pkm->bku_id]) }}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');">
