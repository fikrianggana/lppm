                                                ...
                                                <td>
                                                    ...
                                                    <a href="#" class="btn btn-sm btn-danger fas fa-trash" onclick="
                                                        ...
                                                        if (confirm('Do you want to remove this?')){
                                                            document.getElementById('delete-row-{{ $bk->bku_id }}').submit();
                                                        }">
                                                    </a>
                                                    <form id="delete-row-{{ $product->id }}" action="{{ route('admin.publikasi.buku.destroy', ['bku_id'=>$product->bku_id]) }}" method="POST">
