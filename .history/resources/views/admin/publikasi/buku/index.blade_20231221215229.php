        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p>
                        <a class="btn btn-primary" href="{{ route('admin.publikasi.buku.create') }}">
                            ...
                            @forelse ($buku as $index => $bk)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form method="POST" action="{{ route('admin.publikasi.buku.edit', ['bku_id' => $bk->bku_id]) }}">
                                            @csrf
                                            @method('PUT')
                                        ...
                                        <form id="delete-row-{{ $bk->bku_id }}"
                                            action="{{ route('admin.publikasi.buku.destroy', ['bku_id' => $bk->bku_id]) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
                                            ...
                                            <button type="submit"
                                                ...
                                                aria-hidden="true"
                                                onclick="event.preventDefault(); if (confirm('Do you want to remove this?')){ document.getElementById('delete-row-{{ $bk->bku_id }}').submit(); }">
                                            </button>
                                        </form>

                                        <a href="#" id="detail-{{ $bk->bku_id }}"
