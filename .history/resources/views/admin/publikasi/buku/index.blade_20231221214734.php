                                 ...
                                 @forelse ($buku as $index => $bk)
                                     <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('admin.publikasi.buku.edit', ['bku_id' => $bk->bku_id]) }}"
                                                    <i class="btn btn-warning fa fa-edit" aria-hidden="true"></i>
                                                </a>

                                                <form id="delete-row-{{ $bk->bku_id }}" action="{{ route('admin.publikasi.buku.destroy', ['bku_id' => $bk->bku_id]) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')

                                                    <button type="submit" class="btn btn-sm btn-danger fa fa-trash" aria-hidden="true" onclick="event.preventDefault(); if (confirm('Do you want to remove this?')){ document.getElementById('delete-row-{{ $bk->bku_id }}').submit(); }"></button>
                                                </form>
