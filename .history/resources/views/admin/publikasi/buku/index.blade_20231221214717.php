                                     ...
                                     <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <form id="delete-row-{{ $bk->bku_id }}" action="{{ route('admin.publikasi.buku.destroy', ['bku_id' => $bk->bku_id]) }}" method="POST">
                                                    ...
                                                    <button type="submit" class="btn btn-sm btn-danger fa fa-trash" onclick="event.preventDefault(); if (confirm('Do you want to remove this?')){ document.getElementById('delete-row-{{ $bk->bku_id }}').submit(); }"></button>
                                                </form>
