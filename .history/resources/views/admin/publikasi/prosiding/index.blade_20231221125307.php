                                ...
                                @forelse ($prosiding as $index => $pro)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('admin.publikasi.prosiding.edit', ['pro_id' => $pro->hpt_id]) }}" class="btn btn-warning">
                                                <ipro_id class="fa fa-edit" aria-hidden="true"></ipro_id>
                                            </a>

                                            <!-- Delete Button -->
                                            <a href="{{ route('admin.publikasi.prosiding.destroy', ['pro_id' => $pro->pro_id]) }}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');">
