                                ...
                                @forelse ($hakpaten as $index => $hpt)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('admin.publikasi.hakpaten.edit', ['hpt_id' => $hcp->hpt_id]) }}" class="btn btn-warning">
                                                <i class="fa fa-edit" aria-hidden="true"></i>
                                            </a>

                                            <!-- Delete Button -->
                                            <a href="{{ route('admin.publikasi.hakpaten.destroy', ['hpt_id' => $hcp->hpt_id]) }}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');">
