                                ...
                                @forelse ($hakpaten as $index => $hpt)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('admin.publikasi.hakpaten.edit', ['hpt_id' => $hcp->hcp_id]) }}" class="btn btn-warning">
                                                <i class="fa fa-edit" aria-hidden="true"></i>
                                            </a>

                                            <!-- Delete Button -->
                                            <a href="{{ route('admin.publikasi.hakpaten.destroy', ['hcp_id' => $hcp->hcp_id]) }}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');">
