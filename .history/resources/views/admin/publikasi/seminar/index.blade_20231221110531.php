                                ...
                                @forelse ($seminar as $index => $smn)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('admin.publikasi.seminar.edit', ['smn_id' => $bk->smn_id]) }}" class="btn btn-warning">
                                                <i class="fa fa-edit" aria-hidden="true"></i>
                                            </a>

                                            <!-- Delete Button -->
                                            <a href="{{ route('admin.publikasi.seminar.destroy', ['smn_id' => $bk->smn_id]) }}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');">
