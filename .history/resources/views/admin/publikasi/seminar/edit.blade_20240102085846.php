                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="smn_tempatpelaksaan" value="{{ old('smn_tempatpelaksaan', $smn -> smn_namasmn_tempatpelaksaanpenulis)}}" placeholder="Tempat Pelaksanaan">
                                </div>
                                <br>
                                <div class="col-12">
