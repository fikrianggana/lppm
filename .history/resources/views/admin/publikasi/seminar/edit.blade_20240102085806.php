...
<body>
    ...
    <main id="main" class="main">
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                <form action="{{ route('admin.publikasi.buku.edit', ['bku_id' => $bk->bku_id]) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="smn_penyelenggara" value="{{ old('smn_penyelenggar, $smn -> smn_namapenulis')}}" placeholder="Penyelenggara">
                                </div>
                                <br>
                                <div class="col-12">
                                    <label class="form-label">Waktu</label>
                                    <input type="date" class="form-control" name="smn_waktu" value="{{ old('smn_waktu', $smn -> smn_namapenulis)}}" placeholder="Waktu">
                                </div>
                                <br>
                                <div class="col-12">
                                    <label class="form-label">Tempat Pelaksanaan</label>
                                    <input type="text" class="form-control" name="smn_tempatpelaksaan" value="{{ old('smn_tempatpelaksaan', $smn -> smn_namapenulis)}}" placeholder="Tempat Pelaksanaan">
                                </div>
                                <br>
                                <div class="col-12">
                                    <label class="form-label">Keterangan</label>
                                    <input type="text" class="form-control" name="smn_keterangan" value="{{ old('smn_keterangan', $smn -> smn_namapenulis)}}" placeholder="Keterangan">
                                </div>
                                <br>
                                <div class="col-12">
