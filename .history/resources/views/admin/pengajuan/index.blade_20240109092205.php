                                     ...
                                     <tr>
                                        <td>
                                         ...
                                         <td class="text-center">
                                            <a href="{{ route('admin.pengajuan.edit', ['pst_id' => $pkm->pst_id]) }}" class="btn btn-warning">
                                                <i class="fa fa-edit" aria-hidden="true"></i>
                                            </a>

                                            <!-- Delete Button -->
                                            <a href="{{ route('admin.pengajuan.destroy', ['pst_id' => $pkm->pst_id]) }}"
                                                class="btn btn-danger"
                                                onclick="event.preventDefault(); if(confirm('Are you sure you want to delete this item?')) { document.getElementById('delete-form-{{ $pkm->pst_id }}').submit(); }">
